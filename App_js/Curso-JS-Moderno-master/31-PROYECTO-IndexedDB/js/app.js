...
function nuevaCita(e) {
    ...
    if(editando) {
        ...
        transaction.onerror = () => {
            console.log('Hubo un error en la actulización de los datos');
        }
...
function eliminarCita(id) {
    ...
    transaction.onerror = () => {
        console.log('Hubo un error al borrar el registro');
    }
...
function crearDB() {
    ...
    crearDB.onsuccess = function () {
        console.log('La base de datos citas se creo exitosamente');
